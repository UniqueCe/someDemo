...
- (void)createButtons{
    ...
    UIButton *clearBtn = [UIButton ButtonWithNormalImage:@"laji" selectedImage:nil Target:self Action:@selector(clearButtonClickAction)];
    clearBtn.hidden = YES;
...
- (void)setupHistoryButtons {
    ...
    _seachHistoryView.backgroundColor = [UIColor whiteColor];
